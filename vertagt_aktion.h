...
{
	// Oberklasse VAktion
	//T steht sozusagen für "Typ" und beschreibt einen beliebeigen Datentyp
	template <class T>
	class VAktion
	{
	protected:
	...
	public:
	    VAktion() = delete; // Benötigt man einen Standardkonstruktor? Nein, da abstrakt!
	...
	public:
	    VPushBack() = delete; //in den Konstruktor müssen Parameter gesetzt werden!
	...
	private:
			...
			T p_objekt;
	public:
		VPushFront() = delete; //in den Konstruktor müssen Parameter gesetzt werden!
	...
	public:
		VErase() = delete ; //in den Konstruktor müssen Parameter gesetzt werden!
